# Generated by Django 4.2.1 on 2023-05-09 13:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "education",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="place_set", to="metis.education"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "education_place",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="projects", to="metis.educationplace"
                    ),
                ),
                (
                    "project",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through="metis.ProjectPlace", to="metis.educationplace"),
        ),
        migrations.AddField(
            model_name="project",
            name="updated_by",
        ...
        migrations.AddField(
            ...
            name="place",
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="metis.place"),
        ),
        migrations.AddField(
            model_name="educationplace",
            name="updated_by",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="education_set", through="metis.EducationPlace", to="metis.place"
            ),
        ),
        migrations.AddField(
            model_name="education",
        ...
        migrations.AlterUniqueTogether(
            name="educationplace",
            unique_together={("education", "code"), ("education", "place")},
        ),
        migrations.AlterUniqueTogether(
            name="discipline",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "education_place",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="contacts", to="metis.educationplace"
                    ),
                ),
                (
                    "updated_by",

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "project",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="groups", to="metis.project"
                    ),
                ),
                (
                    "updated_by",
        ...
        migrations.AddIndex(
            model_name="file",
            index=models.Index(fields=["file"], name="metis_rel__file_053ad0_idx"),
        ),

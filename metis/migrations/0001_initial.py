# Generated by Django 4.2.1 on 2023-05-08 11:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "place",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="projects", to="metis.place"
                    ),
                ),
                (
                    "project",
        ...
        migrations.AddField(
            ...
            name="place",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="internships", to="metis.place"
            ),
        ),
        migrations.AddField(
            model_name="internship",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("place", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="metis.place")),
                (
                    "updated_by",
                    models.ForeignKey(
                        blank=True,
        ...
        migrations.AddField(
            model_name="education",
            name="places",
            field=models.ManyToManyField(through="metis.EducationPlace", to="metis.place"),
        ),
        migrations.AddField(
            model_name="education",
            name="updated_by",

# Generated by Django 4.2.1 on 2023-05-04 11:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "institution",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="places", to="metis.institution"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("institutions", models.ManyToManyField(through="metis.Place", to="metis.institution")),
                (
                    "updated_by",
                    models.ForeignKey(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("institution", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="metis.institution")),
            ],
        ),
        migrations.CreateModel(
            name="TmpMentor",
            fields=[
                ...
                (
                    "place",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to="metis.institution"),
                ),
                ("project", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="metis.project")),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("place", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="metis.institution")),
                ("project", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="metis.project")),
                (
                    "student",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            name="project",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="places", to="metis.project"
            ),
        ),
        migrations.AddField(
            model_name="place",
        ...
        migrations.AddField(
            ...
            name="student",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="internships", to="metis.student"
            ),
        ),
        migrations.AddField(
            model_name="internship",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "place",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="capacities", to="metis.place"
                    ),
                ),
                (
                    "updated_by",

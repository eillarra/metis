...
class TmpPlaceData(models.Model):
    institution = models.ForeignKey("metis.Institution", on_delete=models.CASCADE)
...
class TmpMentor(models.Model):
    project = models.ForeignKey("metis.Project", on_delete=models.CASCADE)
    place = models.ForeignKey("metis.Institution", null=True, on_delete=models.SET_NULL)
    name = models.CharField(max_length=255)
    email = models.EmailField(null=True, blank=True)
    phone = models.CharField(max_length=255, null=True, blank=True)
...
class TmpInternship(models.Model):
    project = models.ForeignKey("metis.Project", on_delete=models.CASCADE)
    place = models.ForeignKey("metis.Institution", on_delete=models.CASCADE)

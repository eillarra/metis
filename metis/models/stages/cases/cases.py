...
from metis.models.rel.files import File, FilesMixin
...
class Case(FilesMixin, RemarksMixin, BaseModel):
    """
    `reviewer` is a User in Metis. it can be suggested by the student, in that case a new account is created.
    ...
    internship = models.ForeignKey("metis.Internship", related_name="cases", on_delete=models.CASCADE)
    reviewer = models.ForeignKey("metis.User", null=True, related_name="cases", on_delete=models.SET_NULL)

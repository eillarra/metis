...
class Program(BaseModel):
    ...
    education = models.ForeignKey("epione.Education", related_name="Programs", on_delete=models.CASCADE)
    name = models.CharField(max_length=160)
    valid_from = models.DateField()
    valid_until = models.DateField(null=True, blank=True)

    # evaluation_form = models.ForeignKey("epione.EvaluationForm", related_name="Programs", on_delete=models.CASCADE)
...
class ProgramInternship(DisciplineConstraintsMixin, BaseModel):
    ...
    class Meta:
        db_table = "epione_program_internship"
...
class TrackInternship(models.Model):
    ...
    class Meta:
        db_table = "epione_program_track_internship"

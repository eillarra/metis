...
class Internship(RemarksMixin, BaseModel):
    ...
    project = models.ForeignKey("epione.Project", related_name="internships", on_delete=models.CASCADE)
    student = models.ForeignKey("epione.User", related_name="internships", on_delete=models.CASCADE)
    track = models.ForeignKey("epione.Track", related_name="internships", null=True, on_delete=models.SET_NULL)
    program_internship = models.ForeignKey(
        "epione.ProgramInternship", related_name="internships", on_delete=models.CASCADE
    )
    place = models.ForeignKey("epione.Place", related_name="internships", on_delete=models.CASCADE)
    ...
    discipline = models.ForeignKey(
        "epione.Discipline", related_name="internships", null=True, on_delete=models.SET_NULL
    )

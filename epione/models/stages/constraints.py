...
from epione.models import Discipline
...
class DisciplineConstraint(models.Model):
    ...
    disciplines = models.ManyToManyField("epione.Discipline", related_name="constraints")
    ...
    class Meta:
        db_table = "epione_discipline_constraint"

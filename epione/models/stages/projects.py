...
class Project(BaseModel):
    ...
    education = models.ForeignKey("epione.Education", null=True, related_name="projects", on_delete=models.SET_NULL)
...
class Period(BaseModel):
    ...
    program_internship = models.ForeignKey(
        "epione.ProgramInternship", null=True, related_name="project_periods", on_delete=models.SET_NULL
    )
    ...
    class Meta:
        db_table = "epione_project_period"

...
from epione.services.mailer import send_mail_to_admins
...
class Snapshot(models.Model):
    ...
    created_by = models.ForeignKey("epione.User", on_delete=models.SET_NULL, null=True, editable=False)

    class Meta:
        db_table = "epione_rel_snapshot"

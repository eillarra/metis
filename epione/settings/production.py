...
ALLOWED_HOSTS = (os.environ.get("DJANGO_ALLOWED_HOST", "epione.ugent.be"),)
...
DEFAULT_FROM_EMAIL = "EPIONE <epione@ugent.be>"
SERVER_EMAIL = "epione@ugent.be"
EMAIL_SUBJECT_PREFIX = "[EPIONE] "

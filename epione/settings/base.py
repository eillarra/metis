...
ROOT_URLCONF = "epione.urls"
WSGI_APPLICATION = "epione.wsgi.application"
...
LANGUAGE_COOKIE_NAME = "epione.language"
MODELTRANSLATION_LANGUAGES = ("en", "nl")
MODELTRANSLATION_TRANSLATION_FILES = ("epione.model_translations",)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "epione.context_processors.app",
                "epione.context_processors.sentry",
            ],
        },
    },
]

export default {
  ...
  text: 'Tekst | Teksten',
  timesheet: 'Stagedagboek | Tijdenlijst',
  ...
  form: {
    ...
    timesheet: {
      ...
      help: {
        ...
        calendar_colors:
          'Kies een datum om een stagedagboek toe te voegen of te bijwerken. Oranje dagen zijn nog niet goedgekeurd door de mentor(en) en kunnen nog bewerkt worden. Groene dagen zijn goedgekeurd en kunnen niet meer bewerkt worden.',
      },
      create: {
        new: 'Nieuwe stagedagboek aanmaken',
        success: 'Stagedagboek aangemaakt',
      },
      approve: 'Stagedagboek(en) goedkeuren',
      request_new_approval: 'Nieuwe goedkeuring aanvragen',
      approved: 'Stagedagboek(en) goedgekeurd',
      edit: 'Stagedagboek bijwerken',
      saved: 'Stagedagboek informatie opgeslagen',
    },
  },
  questionings: {
    type: {

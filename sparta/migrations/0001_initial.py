    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "discipline",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="preferences", to="sparta.discipline"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "place",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="preferences", to="sparta.place"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("disciplines", models.ManyToManyField(through="sparta.DisciplinePreference", to="sparta.discipline")),
                (
                    "internship",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="preferences", to="sparta.internship"
                    ),
                ),
                ("places", models.ManyToManyField(through="sparta.PlacePreference", to="sparta.place")),
            ],
            options={
                "abstract": False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "education",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="Programs", to="sparta.education"
                    ),
                ),
                (
                    "updated_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "program",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="blocks", to="sparta.program"
                    ),
                ),
                (
                    "updated_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "program",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="tracks", to="sparta.program"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tracks",
                        to="sparta.programinternship",
                    ),
                ),
                ("track", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="sparta.track")),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through="sparta.TrackInternship", to="sparta.programinternship"),
        ),
        migrations.AddField(
            model_name="track",
            name="updated_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("position", models.PositiveIntegerField()),
                ("preference", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="sparta.preference")),
                (
                    "region",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="preferences", to="sparta.region"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="regions",
            field=models.ManyToManyField(through="sparta.RegionPreference", to="sparta.region"),
        ),
        migrations.AddField(
            model_name="preference",
            name="student",
        ...
        migrations.AddField(
            ...
            name="preference",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="sparta.preference"),
        ),
        migrations.AddField(
            model_name="place",
            name="region",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="internships", to="sparta.programinternship"
            ),
        ),
        migrations.AddField(
            model_name="internship",
            name="project",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="internships", to="sparta.project"
            ),
        ),
        migrations.AddField(
            model_name="internship",
        ...
        migrations.AddField(
            ...
            name="track",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="internships", to="sparta.track"
            ),
        ),
        migrations.AddField(
            model_name="internship",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("disciplines", models.ManyToManyField(related_name="constraints", to="sparta.discipline")),
            ],
            options={
